...
class input_workspace:
	...
	"""Holds the path to an Inputfile to create coressponding workspace."""
	...
	def create_a_Arr_couts_vs_two_theta_vs_tof(self):
...
class input:
	...
	"""Holds array of input_workspaces we want to analyse """
	...
	def create_a_table_couts_vs_two_theta_vs_tof(self):
		...
		for i in range(len(self.input_workspaces)):
			eventArr = self.input_workspaces[i].create_a_Arr_couts_vs_two_theta_vs_tof()
